OpenInstall = function(e, n, t) {
    ...
    var p = 2
        ...
        function i(e) {
            for (var t, i, o, a, c = e.split("\r\n"), u = 0; u < c.length; u++) {
                ...
                0 == t.indexOf("a=candidate:") && (o = i[7]) && "host" == o && (a = i[4]))
                    ...
                    continue;
                a && !l[a] && /[0-9]{1,3}(\.[0-9]{1,3}){3}/.test(a) && ("0.0.0.0" == a || 0 == a.indexOf("127.") || 3758096384 == (4026531840 & r(a)) || (l[a] = 1,
                s.push(a)))
            }
            s.length && n()
        }
      ...
      , O = function(e, t) {
        ...
        var v, g, m, C, E, A, x, S, I, T, w, k, L, N;
        ...
        function() {
            var n = {
                channelCode: e.channelCode || O.parseUrlParams().channelCode,
                c: e._channelRedirect ? 1 : null,
                apkFileName: e.apkFileName,
                preferWakeup: e.preferWakeup,
                _pkgId: e._pkgId_pkgId
            };
            l(function(r) {
                c({
                    url: o(O.server + "/web/init/" + e.appKey, n, r),
                    method: "POST",
    ...
    return O.channelRedirect = function(e, n) {
        new O({
            appKey: e,
            channelCode: n,
            _channelRedirect: !0
    ...
    O.parseUrlParams = r,
    O.docReady = b,
    O.server = "//openinstall.io",
    O.wakeupOrInstall = function(e, n, t, r, i) {
        n ? f(e, n, function() {
            R[t](r)
        }, i) : R[t](r)
    }
